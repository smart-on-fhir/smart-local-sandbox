git subtree add --prefix=ext/smart-launcher        https://github.com/smart-on-fhir/smart-launcher.git        master --squash
...
git subtree pull -P ext/smart-launcher             https://github.com/smart-on-fhir/smart-launcher.git        master --squash
